...
#ifndef WALLETVERSE_IOS_SDK_SWIFT_H
#define WALLETVERSE_IOS_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="walletverse_ios_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC19walletverse_ios_sdk11CommonUtils")
@interface CommonUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC19walletverse_ios_sdk8Constant")
...
SWIFT_CLASS("_TtC19walletverse_ios_sdk11DappWebview")
@interface DappWebview : WKWebView
...
@interface DappWebview (SWIFT_EXTENSION(walletverse_ios_sdk)) <WKScriptMessageHandler>
...
@interface DappWebview (SWIFT_EXTENSION(walletverse_ios_sdk)) <WKNavigationDelegate, WKUIDelegate>
- (void)webView:(WKWebView * _Nonnull)_ didFailProvisionalNavigation:(WKNavigation * _Nonnull)navigation withError:(NSError * _Nonnull)error;
- (WKWebView * _Nullable)webView:(WKWebView * _Nonnull)_ createWebViewWithConfiguration:(WKWebViewConfiguration * _Nonnull)_ forNavigationAction:(WKNavigationAction * _Nonnull)navigationAction windowFeatures:(WKWindowFeatures * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
- (void)webView:(WKWebView * _Nonnull)_ decidePolicyForNavigationResponse:(WKNavigationResponse * _Nonnull)_ decisionHandler:(void (^ _Nonnull)(WKNavigationResponsePolicy))decisionHandler;
- (void)webView:(WKWebView * _Nonnull)_ decidePolicyForNavigationAction:(WKNavigationAction * _Nonnull)_ decisionHandler:(void (^ _Nonnull)(WKNavigationActionPolicy))decisionHandler;
...
SWIFT_CLASS("_TtC19walletverse_ios_sdk11DefaultUtil")
@interface DefaultUtil : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC19walletverse_ios_sdk15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(walletverse_ios_sdk)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(walletverse_ios_sdk)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(walletverse_ios_sdk)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(walletverse_ios_sdk)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(walletverse_ios_sdk)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC19walletverse_ios_sdk12TaskDelegate")
...
SWIFT_CLASS("_TtC19walletverse_ios_sdk11Walletverse")
@interface Walletverse : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
